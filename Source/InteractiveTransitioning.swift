...
extension InteractiveTransitioning {
    ...
    override func finish() {
        ...
        let d = self.transitionDuration - (self.transitionDuration * self.gestureHandler.percentComplete)
    ...
    override func cancel() {
        ...
        let d = self.transitionDuration * (1 - self.gestureHandler.percentComplete)
